"""Tests for ddd_and_design_patterns_structural_isomo.core"""
import pytest
from ddd_and_design_patterns_structural_isomo.core import ActivityDependentSelectiveIntegration
